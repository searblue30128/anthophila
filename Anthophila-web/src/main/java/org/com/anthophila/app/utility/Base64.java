...
public class Base64 {
	...
	public static class InputStream extends java.io.FilterInputStream {
		 ...
		 *
		 * @param in
		 *            the <code>java.io.InputStream</code> from which to read
		 *            data.
		 *
		 * @since 1.3
		 */
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		 ...
		 *
		 * @param out
		 *            the <code>java.io.OutputStream</code> to which data will
		 *            be written.
		 *
		 * @since 1.3
		 */
	...
	private final static byte[] ALPHABET = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E', (byte) 'F',
			...
			(byte) 'V', (byte) 'W', (byte) 'X', (byte) 'Y', (byte) 'Z', (byte) 'a', (byte) 'b', (byte) 'c', (byte) 'd',
